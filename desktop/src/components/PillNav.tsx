...
const PillNav: React.FC<PillNavProps> = ({
  ...
  return (
    <div className="relative z-[1000] w-full md:w-auto flex justify-center">
      <nav
            ...
            {items.map((item, i) => {
              ...
              const PillContent = (
                <>
                  ...
                  {isActive && (
                    <span
                      className="absolute left-1/2 -bottom-[6px] -translate-x-1/2 w-3 h-3 rounded-full z-[4] opacity-45"
                      style={{ background: 'var(--pill-text, #E8E3DA)' }}
                      aria-hidden="true"
                    />
                  )}
                </>
